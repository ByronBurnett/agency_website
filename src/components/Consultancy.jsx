    ...
    <div className="py-16 px-4 bg-white">
      <div className="max-w-[1240px] grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center bg-white px-4">
          ...
          <p>We offer an honest assesment of your talent and level using a traditional and analytical approach to evaluated your skill level. A statisitcal analysis of your numbers can provide insight and a realistic outlook of where you are in your basketball development. Contact us by email with questions and we will assist in finding soultions that meet your needs. </p> <br/>
