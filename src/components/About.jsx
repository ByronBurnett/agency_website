    ...
    <div ref={ref} className="bg-white py-16 px-4">
     ...
     <img src={suit} alt="founder" className="h-96 w-96 mx-auto rounded-full object-cover object-center px-4" />
       <div className="flex flex-col justify-center p-4">
        ...
        <h1 className="md:text-4xl sm:text-3xl text-2xl font-medium py-2" >Founder & Creator</h1>
        <h1 className="md:text-3xl sm:text-2xl text-xl font-bold py-2" >FIBA Agent | Scout</h1>
